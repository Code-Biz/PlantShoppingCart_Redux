...
function ProductList() {
  ...
  const plantsArray = [
    {
      ...
      plants: [
        ...
        {
          name: "Aloe Vera",
          image: "https://cdn.pixabay.com/photo/2018/04",
  ...
  const handleAddToCart = (plant) => {
    ...
    // THE ABPVE METHOD CAN ALSO BE WRITTEN AS GIVEN BELOW. THE DIFFERENCE IS IN THE USE OF BRACKETS AND RETURN STATEMENT:
    // setAddedToCart(()=>{
    //     return {...addedToCart,}
    // });

    console.log(`Items in cart: ${addedToCart}`);
  };
  return (
    <div>
